  ...
  return (
    <Container className='container'>
        <IntroCard>
            ...
            <CalltoAction>
                <a href='mailto:sohilgupta567@gmail.com'>
                    <Button inverted theme={theme}> Hire Me!</Button>
                </a>
                <a href='https://drive.google.com/file/d/1cQvu7mb4evFB4yqtpWAyByNwXIOqPNUW/view?usp=drive_link' target='_blank' rel='noopener noreferrer'><Button theme={theme}> Resume </Button></a>
            </CalltoAction>
        </IntroCard>
